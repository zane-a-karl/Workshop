...
class ZKLogoAnimation {
    constructor(radius, speed, phaseOffset) {
        ...
        this.saveOriginalPositions(this.centerX, this.centerY);
    ...
    saveOriginalPositions(centerX, centerY) {
    ...
    update() {
        ...
        this.morseElements.forEach((element, index) => {
            ...
            this.applyCircularMotion(element, position, index);
    ...
    applyCircularMotion(element, position, elementIndex) {
